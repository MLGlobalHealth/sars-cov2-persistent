...
omicronBA1_sequences_file = 'omicron_BA1_sequences.csv'
output_csv_file = 'omicron_BA1_nucleotide_counts_per_position.csv'

# Read the CSV file to get the list of sequence names
omicronBA1_sequences_df = pd.read_csv(omicronBA1_sequences_file)
omicronBA1_sequences_set = set(omicronBA1_sequences_df['strain'].tolist())
...
for record in SeqIO.parse(fasta_file, "fasta"):
    if record.id in omicronBA1_sequences_set:
