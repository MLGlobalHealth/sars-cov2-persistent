...
omicronBA2_sequences_file = 'omicron_BA2_sequences.csv'
output_csv_file = 'omicron_BA2_nucleotide_counts_per_position.csv'

# Read the CSV file to get the list of sequence names
omicronBA2_sequences_df = pd.read_csv(omicronBA2_sequences_file)
omicronBA2_sequences_set = set(omicronBA2_sequences_df['strain'].tolist())
...
for record in SeqIO.parse(fasta_file, "fasta"):
    if record.id in omicronBA2_sequences_set:
