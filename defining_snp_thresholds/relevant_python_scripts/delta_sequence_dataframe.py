...
delta_sequences_file = 'delta_sequences.csv'
output_csv_file = 'delta_nucleotide_counts_per_position.csv'

# Read the CSV file to get the list of sequence names
delta_sequences_df = pd.read_csv(delta_sequences_file)
delta_sequences_set = set(delta_sequences_df['strain'].tolist())
...
for record in SeqIO.parse(fasta_file, "fasta"):
    if record.id in delta_sequences_set:
